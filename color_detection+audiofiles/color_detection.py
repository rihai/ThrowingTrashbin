...
audio_files = ['Thanos.wav', 'Loki.wav', 'insult1.wav', 'insult2.wav', 'insult3.wav'] # add additional file names here
pygame.mixer.init()
...
green_lower = np.array([25,67,25],np.uint8) # [25,52,72]
...
def right_trash():
    ...
    time.sleep(5)
    GPIO.output(rightTrash, GPIO.HIGH)
    time.sleep(45) # waits 45 seconds before contiuning
    return
...
def wrong_trash():
    ...
    time.sleep(45) # waits 45 seconds before continuing
    return
